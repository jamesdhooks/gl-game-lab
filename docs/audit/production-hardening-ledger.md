...
| RND-01 | Critical | WebGL context restoration does not recreate owned GPU resources. | 4 | Active | Prioritized restoration, pipeline rebuild, textures, image backing, six GPU bundles, and shared particle/segment/mesh/metaball/effect renderers are recreated; Fluid Tank migration and forced-loss browser equivalence proof remain. |
...
| RND-03 | High | Public content imports concrete WebGL2 renderer APIs, preventing backend neutrality. | 4, 6, 7 | Active | Engine contracts cover sprites, text, textures, camera, particles, shapes, metaballs, fullscreen shaders, backdrop, and bloom. Games plus 7 of 14 simulations have zero renderer-package imports; six GPU-authoritative simulations and Fluid Tank remain. |
