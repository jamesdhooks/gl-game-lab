...
| RND-01 | Critical | WebGL context restoration does not recreate owned GPU resources. | 4 | Active | Prioritized restoration registry and built-in renderer-pipeline rebuild are implemented; textures, simulation resources, and browser equivalence proof remain. |
