...
| RND-03 | High | Public content imports concrete WebGL2 renderer APIs, preventing backend neutrality. | 4, 6, 7 | Active | Engine 2D contracts now cover sprites, text, logical textures, camera, particles, backdrop, and bloom. Ball Pit and the entire games package have zero renderer-package imports; 14 simulation plugins and advanced GPU feature contracts remain. |
