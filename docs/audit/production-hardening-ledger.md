...
| RND-03 | High | Public content imports concrete WebGL2 renderer APIs, preventing backend neutrality. | 4, 6, 7 | Active | Engine contracts cover conventional draws, shape/effect features, and managed fluid fields. Games plus 8 of 14 simulations have zero renderer-package imports; only six GPU-authoritative simulations remain. |
