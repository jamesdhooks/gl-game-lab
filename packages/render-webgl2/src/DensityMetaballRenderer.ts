...
export class DensityMetaballRenderer {
  ...
  private readonly compositePaletteMapping: WebGLUniformLocation;
  ...
  constructor(private readonly gl: WebGL2RenderingContext) {
    ...
    this.compositePaletteMapping = requireShaderUniform(gl, this.compositeProgram, 'uPaletteMapping', 'density metaball composite');
