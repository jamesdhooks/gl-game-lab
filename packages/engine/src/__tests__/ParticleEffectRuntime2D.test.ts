...
describe("EngineParticleEffects2D", () => {
  ...
  it("validates and forwards dynamic event parameters", () => {
    ...
    instance.setEventParameters("spark", 0, { probability: 0.5, count: 7, delay: 0.2, powerScale: 0.8, minimumSpeed: 40, countSpeedScale: 2, speedReference: 500, basePower: 120 });
    expect(backend.resources[0]!.eventParameters.get("0:0")).toEqual({ probability: 0.5, count: 7, delay: 0.2, powerScale: 0.8, minimumSpeed: 40, countSpeedScale: 2, speedReference: 500, basePower: 120 });
